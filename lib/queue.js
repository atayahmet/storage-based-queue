...
Queue.prototype.add = (() => {var _ref = _asyncToGenerator(function* (task) {
    ...
    return id;
  });function add(_x) {return _ref.apply(this, arguments);}return add;})();
...
/**
                                                                             ...
                                                                             * @api public
                                                                             */
Queue.prototype.next = (() => {var _ref2 = _asyncToGenerator(function* () {
    if (this.stopped) {
      statusOff.call(this);
    ...
    return true;
  });function next() {return _ref2.apply(this, arguments);}return next;})();
...
/**
                                                                              ...
                                                                              * @api public
                                                                              */
Queue.prototype.start = (() => {var _ref3 = _asyncToGenerator(function* () {
    ...
    return this.running;
  });function start() {return _ref3.apply(this, arguments);}return start;})();
...
/**
    ...
    * @api public
    */
Queue.prototype.isEmpty = (() => {var _ref4 = _asyncToGenerator(function* () {
    return (yield this.count()) < 1;
  });function isEmpty() {return _ref4.apply(this, arguments);}return isEmpty;})();
...
/**
                                                                                    ...
                                                                                    * @api public
                                                                                    */
Queue.prototype.count = (() => {var _ref5 = _asyncToGenerator(function* () {
    return (yield getTasksWithoutFreezed.call(this)).length;
  });function count() {return _ref5.apply(this, arguments);}return count;})();
...
Queue.prototype.countByTag = (() => {var _ref6 = _asyncToGenerator(function* (tag) {
  ...
  });function countByTag(_x2) {return _ref6.apply(this, arguments);}return countByTag;})();
...
/**
    ...
    * @api public
    */
Queue.prototype.clearByTag = (() => {var _ref7 = _asyncToGenerator(function* (tag) {
    const self = this;
    const data = yield db.call(self).all();
    const removes = data.filter(utilClearByTag.bind(tag)).map((() => {var _ref8 = _asyncToGenerator(function* (t) {
  ...
  });function clearByTag(_x3) {return _ref7.apply(this, arguments);}return clearByTag;})();
...
/**
                                                                                             ...
                                                                                             * @api public
                                                                                             */
Queue.prototype.has = (() => {var _ref9 = _asyncToGenerator(function* (id) {
    return (yield getTasksWithoutFreezed.call(this)).findIndex(function (t) {return t._id === id;}) > -1;
  });function has(_x5) {return _ref9.apply(this, arguments);}return has;})();
...
/**
                                                                               ...
                                                                               * @api public
                                                                               */
Queue.prototype.hasByTag = (() => {var _ref10 = _asyncToGenerator(function* (tag) {
    return (yield getTasksWithoutFreezed.call(this)).findIndex(function (t) {return t.tag === tag;}) > -1;
  });function hasByTag(_x6) {return _ref10.apply(this, arguments);}return hasByTag;})();
...
/**
    ...
    * @api public
    */
Queue.workers = function workers() {let workersObj = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
...
/**
    ...
    * @api public
    */
Queue.deps = function deps() {let dependencies = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
...
/**
    ...
    * @api public
    */
Queue.use = function use() {let driver = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
