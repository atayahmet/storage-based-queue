...
export default class StorageCapsule {
  ...
  delete(id) {var _this4 = this;return _asyncToGenerator(function* () {
      ...
      yield _this4.storage.set(_this4.storageChannel, data.filter(function (d) {return d;}));
  ...
  /**
     ...
     * @api public
     */
  all() {var _this5 = this;return _asyncToGenerator(function* () {
  ...
  /**
     ...
     * @api public
     */
  isExceeded() {var _this6 = this;return _asyncToGenerator(function* () {
  ...
  /**
     ...
     * @api public
     */
  clear(channel) {var _this7 = this;return _asyncToGenerator(function* () {
