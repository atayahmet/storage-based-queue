...
Config = function () {
  ...
  function Config() {var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};_classCallCheck(this, Config);this.config = _config2.default;
    this.merge(config);
  }_createClass(Config, [{ key: 'merge', value: function merge(
...
Container = function () {
  ...
  function Container() {_classCallCheck(this, Container);this.
    ...
    id, value) {
      this._container = Object.defineProperty(this._container, id, { value: value });
    } }, { key: 'freeze', value: function freeze(

    id) {
      this._container = Object.freeze(this._container[id]);
...
'use strict';Object.defineProperty(exports, "__esModule", { value: true });var _createClass = function () {function defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}return function (Constructor, protoProps, staticProps) {if (protoProps) defineProperties(Constructor.prototype, protoProps);if (staticProps) defineProperties(Constructor, staticProps);return Constructor;};}();function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}var Event = function () {
  ...
  function Event() {_classCallCheck(this, Event);this.store = {};
    this.store.before = {};
    this.store.after = {};
    this.store.error = function () {};
    this.store['*'] = function () {};
    ...
    key) {
      ...
      var cb = this.store[type][name];
      if (cb) cb.call();
    } }, { key: 'emitError', value: function emitError(

    args) {
      this.store.error.call(this, args);
    ...
    cb) {
      this.store.error = cb;
    } }, { key: 'is', value: function is(

    key, type) {
      var pattern = new RegExp('^[a-z0-9-_]+:' + type);
    ...
    key) {
      return (/^[a-z0-9\-\_]+\:before$|after$|\*$/.test(key) || ['*', 'error'].indexOf(key) > -1);
    } }]);return Event;}();exports.default = Event;

},{}],5:[function(require,module,exports){
'use strict';var _createClass = function () {function defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}return function (Constructor, protoProps, staticProps) {if (protoProps) defineProperties(Constructor.prototype, protoProps);if (staticProps) defineProperties(Constructor, staticProps);return Constructor;};}();var _queue = require('./queue');var _queue2 = _interopRequireDefault(_queue);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}var

SendEmail = function () {function SendEmail() {_classCallCheck(this, SendEmail);this.
    priority = 5;this.
    retry = 1;}_createClass(SendEmail, [{ key: 'handle', value: function handle(

    args, product, category) {
      try {
        console.log('handle->', args, product, category);
    ...
    } }, { key: 'before', value: function before(

    args) {
      console.log('before event', args);
    } }, { key: 'after', value: function after(
...
_queue2.default.register([
{ handler: SendEmail, deps: { a: 1, b: 2 } }]);


var queue = new _queue2.default({ storage: { type: 'localstorage', prefix: 'sq_jobs' } });

queue.on('*', function () {
  console.log('wild card');
});

queue.on('test:*', function () {
  console.log('test beforeeee');
});

queue.error(function (task) {
  console.log('errorrrrrr', task);
});

// queue.on('test-2:before', function() {
//   console.log('test-2 beforeeee');
// });

// queue.on('test-3:before', function() {
//   console.log('test-3 beforeeee');
// });

// queue.on('test-3:after', function() {
//   console.log('test-3 afterrr');
// });

var a = queue.create('test-1');

// console.log('---X----', a.add({b: 1}));

var b = queue.create('test-2');
var c = queue.create('test-3');
var d = queue.create('test-4');
a.setTimeout(600);

a.add({ tag: 'test', handler: 'SendEmail', priority: 1, args: 'jobs args 2' });
a.add({ tag: 'test', handler: 'SendEmail', priority: 1, args: 'jobs args 2' });
a.add({ tag: 'test-2', handler: 'SendEmail', priority: 1, args: 'jobs args 2' });
a.add({ tag: 'test-2', handler: 'SendEmail', priority: 1, args: 'jobs args 2' });
a.add({ tag: 'test-3', handler: 'SendEmail', priority: 1, args: 'jobs args 2' });
a.add({ tag: 'test-3', handler: 'SendEmail', priority: 1, args: 'jobs args 2' });
a.add({ tag: 'test-3', handler: 'SendEmail', priority: 1, args: 'jobs args 2' });
...
// c.setTimeout(600);
// d.setTimeout(600);
// for (let i = 0; i <= 100; i++) b.add({handler: 'SendEmail', priority: 1, args: 'jobs args'});
// for (let i = 0; i <= 100; i++) a.add({handler: 'SendEmail', priority: 1, args: 'jobs args 2'});
// for (let i = 0; i <= 100; i++) c.add({handler: 'SendEmail', priority: 1, args: 'jobs args 3'});
// for (let i = 0; i <= 100; i++) d.add({handler: 'SendEmail', priority: 1, args: 'jobs args 4'});

// b.add({handler: 'SendEmail', priority: 2, args: 'jobs args 3'});
// b.add({handler: 'SendEmail', priority: 3, args: 'jobs args 4'});

// b.start();
// b.forceStop();

// setTimeout(() => {b.stop();}, 10000);
a.start();
// c.start();
// d.start();
// a.forceStop();
...
// const a = queue.channel('test-1');
// const b = queue.channel('test-2');
...
var _utils = require('./utils');function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _toConsumableArray(arr) {if (Array.isArray(arr)) {for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) {arr2[i] = arr[i];}return arr2;} else {return Array.from(arr);}}

// retry
// priority

// debug('worker:a')('Helloo');
...
var Queue = function () {
  ...
  Queue.prototype.add = function (task) {
    saveTask.call(this, task);
  };

  function dispatchEvents(task, type) {
    if ('tag' in task) {
      this.event.emit(task.tag + ':' + type);
      this.event.emit(task.tag + ':*');
    }
  }
  ...
  function saveTask(task) {
    db.call(this).save(task);
  }

  function createTimeout() {
    this.currentTimeout = setTimeout(loopHandler.bind(this), this.timeout);
  ...
  function loopHandler() {var _jobInstance$handle;
    ...
    // fire wildcard event for before process
    this.event.wildcard();

    // Task runner promiseeask
    (_jobInstance$handle = jobInstance.handle).call.apply(_jobInstance$handle, [jobInstance, task.args].concat(_toConsumableArray(Object.values(job.deps)))).
  ...
  function jobResponse(task, job) {
    ...
    return function (result) {
      ...
      // fire wildcard event for after process
      this.event.wildcard();
  ...
  function jobFailedResponse(task, job) {var _this = this;
    return function (result) {
      removeTask.call(_this, task._id);
      _this.event.emitError(task);
      _this.next();
    };
  }
  ...
  function registerJobs() {var _iteratorNormalCompletion = true;var _didIteratorError = false;var _iteratorError = undefined;try {
      for (var _iterator = Queue.jobs[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {var job = _step.value;var _job$handler$toString =
        job.handler.toString().match(/function\s([a-zA-Z_]+).*?/),_job$handler$toString2 = _slicedToArray(_job$handler$toString, 3),strFunction = _job$handler$toString2[0],name = _job$handler$toString2[1],hello = _job$handler$toString2[2];
...
},{"./config":2,"./container":3,"./event":4,"./storage":7,"./utils":9}],7:[function(require,module,exports){
'use strict';Object.defineProperty(exports, "__esModule", { value: true });var _createClass = function () {function defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}return function (Constructor, protoProps, staticProps) {if (protoProps) defineProperties(Constructor.prototype, protoProps);if (staticProps) defineProperties(Constructor, staticProps);return Constructor;};}();

var _lodash = require('lodash.groupby');var _lodash2 = _interopRequireDefault(_lodash);
var _lodash3 = require('lodash.orderby');var _lodash4 = _interopRequireDefault(_lodash3);
...
Storage = function () {
  ...
  function Storage(config) {_classCallCheck(this, Storage);
    this.setConfig(config);
    this.storage = new _localstorage2.default(config);

  }_createClass(Storage, [{ key: 'setConfig', value: function setConfig(
    ...
    {
      var tasks = (0, _lodash2.default)(this.all().filter(_utils.excludeSpecificTasks), function (t) {return t.priority;});
      return Object.keys(tasks).
      map(function (key) {return parseInt(key);}).
      sort().
      reverse().
      reduce(function (result, key) {
        return result.concat((0, _lodash4.default)(tasks[key], function (t) {return t.createdAt;}, 'asc'));
      }, []);
    ...
    id) {
      try {
        var data = this.all().filter(function (t) {return t._id != id;});
        this.storage.set(this.storageChannel, JSON.stringify(data));
        return true;
      } catch (e) {
        return false;
...
},{"./config":2,"./storage/localstorage":8,"./utils":9,"lodash.groupby":10,"lodash.orderby":11}],8:[function(require,module,exports){
'use strict';Object.defineProperty(exports, "__esModule", { value: true });var _createClass = function () {function defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}return function (Constructor, protoProps, staticProps) {if (protoProps) defineProperties(Constructor.prototype, protoProps);if (staticProps) defineProperties(Constructor, staticProps);return Constructor;};}();function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}var
...
'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.clone = clone;exports.
